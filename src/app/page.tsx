  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
             <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                I'm always open to discussing new projects, creative ideas, or opportunities. Feel free to reach out to me at <a href="mailto:girishmadhu03@gmail.com" className="text-primary hover:underline">girishmadhu03@gmail.com</a>.
              </p>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center justify-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground text-center">© Girish M | Design and Developed by girishmadhu03@gmail.com</p>
      </footer>
      <ScrollToTop />
    </div>
  );
